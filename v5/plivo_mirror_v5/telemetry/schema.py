...
ATTR_AUDIO_DURATION_MS = "mirror.audio_duration_ms"
# Optional per-turn RMS/level samples (list[float] 0..1) for the signal view.
ATTR_AUDIO_LEVELS = "mirror.audio_levels"
